...
- **Content**: เนื้อหาจริง (text, images, etc.) - **Padding**: ระยะห่างด้านใน (ระหว่าง content และ border) - **Border**: กรอบรอบ element - **Margin**: ระยะห่างด้านนอก (ระหว่าง element นี้กับ element อื่น)
